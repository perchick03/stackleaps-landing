...
const PROSPECT_SLUG = "dmc-tiernan-travel";
    ...
    <main className="proposal-root">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-14 items-center pt-10 md:pt-12 pb-12 md:pb-16">
            <div className="space-y-7">
              ...
              <p className="text-[17px] md:text-[19px] leading-[1.55] text-[var(--color-on-surface-variant)] max-w-xl">
                60 days. Done-for-you outreach and booked introductions with the US
                advisors and operators who should be sending their clients to you for
                the UK &amp; Ireland.
              </p>

              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-[var(--color-on-surface)]/12">
                <CoverMeta label="Presented to" value="Kristine Bileskalne" sub="Tiernan Travel" />
            ...
            <div className="relative">
              ...
              <div className="relative w-full aspect-[5/6] overflow-hidden">
                <Image
                  src="/images/proposals/tiernan.jpg"
                  alt=""
                  fill
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-5xl">
          <div>
            ...
            <ul className="space-y-3 text-[16px] leading-[1.6] mt-5">
              <SmallBullet>A luxury, fully-bespoke product for the UK &amp; Ireland</SmallBullet>
              <SmallBullet>American clients who stay with you once they&apos;re in</SmallBullet>
              <SmallBullet>Steady ~18% organic growth from SEO, referrals and word of mouth</SmallBullet>
              <SmallBullet>A reputation strong enough to skip trade fairs for 18 months</SmallBullet>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-[16px] leading-[1.65] mt-5">
              <p>
                We put you in front of US travel advisors, host agencies and tour
                operators actively looking for a UK &amp; Ireland DMC - the same people
                you&apos;d meet at a trade fair, without the ~$20k and the flights.
              </p>
              <p className="italic text-[var(--color-primary)] text-[18px] leading-snug pt-2">
                A predictable channel you can finally benchmark against the fairs - turn
                up for 2027, down whenever you&apos;re full.
              </p>
            </div>
          </div>
        </div>
      ...
      <Page id="what-we-do" no="02" total="07" title="What we do" runner="§ II · Offer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <PhaseCard
            ...
            bullets={[
              "Define your ideal buyer - luxury, UK & Ireland, American clients",
              "Seed it from the two lists you sent - find the current decision-makers behind them",
              "Hand you the top 50 best-fit advisors and operators",
      ...
      <Page id="scope" no="03" total="07" title="Inclusion / Exclusion" runner="§ III · Scope">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          <ScopeColumn
            ...
            tone="in"
            items={[
              "Partner Match Report - 50-contact sample seeded from your two lists, your approval before launch",
              "Personalised outreach to US advisors & operators selling UK / Ireland",
              "Email infrastructure - domains, inboxes, warmup, deliverability",
              "Replies in your voice and tone",
              "Booking + reminder sequences",
              "Exclusivity - no competing UK & Ireland luxury DMC gets this engine",
            ]}
          />
          <ScopeColumn
            title="Not included"
            tone="out"
            items={[
              "The introductory call itself - you take it",
              "Post-call follow-up",
              "Website / brand / pricing work",
              "New markets you don't want - we stay on UK & Ireland for US clients",
      ...
      <Page id="process" no="04" total="07" title="Process & timeline" runner="§ IV · Process">
        <p className="text-[16px] leading-[1.65] mb-10 max-w-3xl text-[var(--color-on-surface-variant)]">
          Targeting 2027? Start now. Luxury planning cycles run months, so outreach
          today is what fills next season&apos;s calendar.
        </p>
        ...
        <div className="border-t border-[var(--color-on-surface)]/15">
          <ProcessRow
            ...
            sub="Partner Match Report drafted from your two lists. Sample asset drafted."
          />
          <ProcessRow
            week="Week 1–2"
      ...
      <Page id="pricing" no="05" total="07" title="Pricing" runner="§ V · Pricing">
        ...
        <p className="mt-10 italic text-[var(--color-on-surface-variant)] text-[15px] leading-[1.65] max-w-2xl">
          For context: a single trade fair runs ~$20K in stand, travel and time - with
          no guarantee of a single fit. The pilot is a fraction of that, with UK &amp;
          Ireland exclusivity included.
        </p>
      </Page>

      {/* =================== WHY US =================== */}
      <Page id="why" no="06" total="07" title="Why this fits Tiernan Travel" runner="§ VI · Why us">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <WhyCard
          ...
          <WhyCard
            ...
            icon={<ShieldIcon />}
          >
            While you&apos;re a client, no competing UK &amp; Ireland luxury DMC gets
            this engine.
          </WhyCard>
          <WhyCard
            label="Easy out"
      ...
      <Page id="next" no="07" total="07" title="Next step" runner="§ VII · Next step" last>
        <p className="text-[18px] leading-[1.6] max-w-2xl mb-8">
          A 20-minute call to confirm voice, what your ideal advisor looks like, and how
          we narrow the two lists you sent into a shortlist. If aligned, onboarding
          starts the same week.
        </p>
        ...
        <Container>
          <div className="py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-2 font-mono text-[11px] tracking-[0.18em] uppercase">
            ...
            <span className="opacity-70">
              Proposal · Tiernan Travel · 2026-06-25
            </span>
          </div>
        </Container>
      </footer>
